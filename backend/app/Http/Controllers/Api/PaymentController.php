...
use App\Models\{Payment,Property,Appointment};
...
class PaymentController extends Controller
{
    ...
    // Valider une visite et libérer le paiement
    ...
    // Annuler un rendez-vous et traiter le remboursement
    public function cancelAppointment(Request $request, $id)
    {
        ...
        app(\App\Services\Refunds\RefundService::class)
